...
const SYSTEM_MESSAGE = `You are a French teacher helping a student prepare for the TCF speaking test.`;
...
function buildPrompt(userIntro: string, count: number, asked: string[]) {
  ...
  return `
You are a French teacher preparing students for the TCF speaking test.
